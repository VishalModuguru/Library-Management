        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="form-group">
                    <label for=""><h6>Book Author(ID):</h6></label>
                    <input type="text" name="book_author" class="form-control" required="">
                    </div>
                    <div class="form-group">
                    <label for=""><h6>Category(ID):</h6></label>
                    <input type="text" name="book_category" class="form-control" required="">
                    </div>
                    <div class="form-group">
                    <label for=""><h6>Book Number</h6></label>
                    ...
                    <button class="btn btn-primary" name="add_book">ADD</button>
                    </form>
