...
<div class="col-md-4">
<div class="box">
<img src="../img/1024px-Circle-icons-profile.svg.png" alt="" style="padding:20px;">
<form action="">
<div class="form-group">
<label for="">Name:</label>
<input type="text" class="form-control" value="<?php echo $name; ?>"  style="background-color:#a4b3ba;color:black;" disabled>
</div>
<div class="form-group">
<label for="">Email:</label>
<input type="text" class="form-control" value="<?php echo $email; ?>" style="background-color:#a4b3ba;color:black;" disabled>
</div>
<div class="form-group">
<label for="">Mobile:</label>
<input type="text" class="form-control" value="<?php echo $mobile; ?>" style="background-color:#a4b3ba;color:black;" disabled >
</div>
</form>
</div>
</div>
