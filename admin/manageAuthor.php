        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <td><button name=""><a href="editAuthor.php?aid=<?php echo $row['author_id'];?>">Edit</a></button>
                    <button name=""><a href="deleteAuthor.php?aid=<?php echo $row['author_id'];?>">Delete</a></button>
                    </td>
                    </tr>
                    <?php 
                    }
